...
func TestEnsureRunSessionAndRecordPromptReferences(t *testing.T) {
	...
	pegasussession.RecordPromptReferences(extended, req.AppName, req.UserID, req.SessionID, cfg.Workspace, `review @main.go from [session:past role:user] cache decision`)
