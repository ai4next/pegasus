...
import (
	...
	pegasus "github.com/ai4next/pegasus/internal/agent"
	...
	"github.com/ai4next/pegasus/internal/model"
...
var runCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		a, extraPlugins, err := pegasus.New(llm, cfg, nil, sessionService, nil, nil, nil)
		if err != nil {
		...
		for event, err := range pegasusruntime.StreamRun(ctx, r, req, nil) {
			if err != nil {
...
func ensureRunSession(ctx context.Context, sessionService adksession.Service, req *pegasusruntime.RunRequest) error {
