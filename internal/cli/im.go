...
import (
	...
	"github.com/ai4next/pegasus/internal/im"
	"github.com/ai4next/pegasus/internal/im/weixinsetup"
	"github.com/ai4next/pegasus/internal/memory"
	pegasusmodel "github.com/ai4next/pegasus/internal/model"
	"github.com/ai4next/pegasus/internal/plugin"
	pegasussession "github.com/ai4next/pegasus/internal/session"
	"github.com/ai4next/pegasus/internal/task"
	"github.com/ai4next/pegasus/internal/tool"
)

var imCmd = &cobra.Command{
	Use:   "im",
	Short: "Run Pegasus through instant-messaging platforms",
}

var imServeCmd = &cobra.Command{
	Use:   "serve",
	Short: "Run the IM integration server",
	Long:  "Run a long-lived server process that connects Pegasus to configured instant-messaging platforms.",
...
func serveIM(ctx context.Context) error {
	...
	llm, err := pegasusmodel.New(ctx, cfg.Model)
	if err != nil {
	...
	sessionService, err := pegasussession.NewService()
	if err != nil {
