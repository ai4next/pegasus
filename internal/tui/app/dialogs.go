...
func (m *Model) selectedSearchResult() (pegasussession.MessageSearchResult, bool) {
	if m.searchDialog == nil || len(m.searchDialog.Results) == 0 {
		return pegasussession.MessageSearchResult{}, false
	}
...
func (m *Model) insertSearchReference(result pegasussession.MessageSearchResult) {
...
func formatSearchReference(result pegasussession.MessageSearchResult) string {
